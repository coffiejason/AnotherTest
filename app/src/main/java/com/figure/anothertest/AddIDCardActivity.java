...
public class AddIDCardActivity extends AppCompatActivity {
    ...
    private TextView nice_to_see_you_text_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String temp = lUsername.getText().toString();
                if(!temp.isEmpty()){
                    SharedPrefs.setIDnumber(lUsername.getText().toString());

                    Log.d("textsetoh3",""+SharedPrefs.getIDnumber());
                    finish();
                }
        ...
        lUsername.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
    ...
    void init(){
        ...
        nice_to_see_you_text_view = findViewById(R.id.nice_to_see_you_text_view);
